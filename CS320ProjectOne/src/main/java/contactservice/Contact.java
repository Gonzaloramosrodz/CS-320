...
public class Contact {
    ...
    public Contact(String contactId, String firstName, String lastName, String phone, String address) {
        ...
        if (phone == null || phone.length() != 10) throw new IllegalArgumentException("Phone must be 10 digits");
        if (address == null || address.length() > 30) throw new IllegalArgumentException("Address too long");
